...
@Database(entities = [FavouriteGithubUser::class], version = 1, exportSchema = false)
    ...
    companion object{
        ...
        fun getFavouriteUserDatabase(context: Context) : FavouriteUserDatabase?{
            if (DATABASE_INSTANCE==null){
                DATABASE_INSTANCE=Room.databaseBuilder(context.applicationContext,FavouriteUserDatabase::class.java,"favourite_user_db").build()
            }
